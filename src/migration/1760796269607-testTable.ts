...
export class TestTable1760796269607 implements MigrationInterface {
    name = 'TestTable1760796269607'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "retailers" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "mobile" integer NOT NULL, "address" character varying NOT NULL, "created_by" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1228653999402b52e75d40b1c66" PRIMARY KEY ("id"))`);
